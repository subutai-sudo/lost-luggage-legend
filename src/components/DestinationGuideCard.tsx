...
export function DestinationGuideCard({ guide, variant = 'default' }: Props) {
  const url = getGuideAffiliateUrl(guide)
    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6">
          ...
          {/* CTA */}
          <div className="flex items-center gap-2 text-[#c9a96e] text-sm font-semibold group-hover:gap-3 transition-all">
            <span style={{ fontFamily: "'Source Sans 3', sans-serif" }}>Explore on Expedia</span>
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer sponsored"
      className="group block overflow-hidden rounded-sm bg-white shadow-sm hover:shadow-xl transition-shadow duration-300"
    >
      {/* Image */}
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 text-[#c9a96e] text-sm font-semibold">
          <span style={{ fontFamily: "'Source Sans 3', sans-serif" }}>View on Expedia</span>
